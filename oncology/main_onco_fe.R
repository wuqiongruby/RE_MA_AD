...
start <- Sys.time()
fit.fe.nonhist.250.vague <- stan(file = paste0(code.dir, "fe_nonhist_250_vague.stan"), 
                                 data = madata,
                                 chains = 5,
                                 iter = 20000,
                                 warmup = 10000,
...
save(fit.fe.nonhist.250.vague, run.time, file = paste0(wk.dir, "results/fe_nonhist_250_vague.RData"))
