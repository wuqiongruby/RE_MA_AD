...
model {
  // priors
  muPhi ~ cauchy(0, 2.5); // scale = 0.37 or 2.5
  sigmaPhi ~ normal(0, 0.5);
  q0 ~ beta(0.5, 0.5);
  q1 ~ beta(0.5, 0.5);
  muL ~ normal(-4.27, log(10)); // as weakly-informative prior
  muM0 ~ normal(log(0.22), log(10)); // as weakly-informative prior
  muM1 ~ normal(log(0.22), log(10)); // as weakly-informative prior
  sigmaL ~ normal(0, log(10)); // as weakly-informative prior
  sigmaM0 ~ normal(0, log(10)); // as weakly-informative prior
  sigmaM1 ~ normal(0, log(10)); // as weakly-informative prior
